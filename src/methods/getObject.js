/**
 * sui_getObject 处理器
 * 参数: [id, { showType, showOwner, showPreviousTransaction, showDisplay, showContent, showBcs, showStorageRebate }]
 * 对应: LedgerServiceClient.getObject
 */
export function createGetObjectHandler(grpcClient) {
  return async (params) => {
    ...
    console.log(`[gRPC] Calling LedgerServiceClient.getObject`, { id, options });
